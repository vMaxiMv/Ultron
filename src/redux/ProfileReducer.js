    ...
    return (dispatch) => {
        ...
        //     .then(data=>{
                dispatch(FillActivityAC( [{'id_user': 56, 'id_entery': 1, 'name': 'Test User', 'amount': 82, 'date_added': '2023-07-20','description':'Первый подход: 20 повторений, второй подход: 10 повторений, третией подход: 5 повторений'},
                    ...
                    {'id_user': 56, 'id_entery': 9, 'name': 'Test User', 'amount': 57, 'date_added': '2023-07-12' ,'description':'какое-то описание'},
                    {'id_user': 57, 'id_entery': 9, 'name': 'Test User 2', 'amount': 57, 'date_added': '2023-07-12' ,'description':'какое-то описание'},
